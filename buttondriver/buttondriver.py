...
class ButtonPanel:
    ...
    def __init__(self):
        ...
        self.buttons.invert_port(0, 0xFF) // so button pressed = 1
        self.buttons.invert_port(1, 0xFF) // so button pressed = 1
        self.buttons.set_port_pullups(0, 0xFF)
        self.buttons.set_port_pullups(1, 0xFF)
